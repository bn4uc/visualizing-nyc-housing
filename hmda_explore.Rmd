...
ggplot() + geom_sf(data = census_tract_merged, 
        ...
        axis.line = element_blank(),
        text = element_text(family = "Meiryo"), 
        axis.ticks = element_blank()) + labs(title = "Loan Approval rates for low-income applicants in Brooklyn \nincreased most significantly in tracts that are further from Manhattan, while they decreased \nin about half of the census tracts", subtitle = "Change in loan application approval rates for low-income applicants between 2013 and 2017 in Brooklyn")
...
hmda_ny_5yrs %>% left_join(census_tracts_bk, by = c("census_tract_number" = "ct2010")) %>% group_by(nta_name)
