...
quartile_race_year_outcome %>% 
  ...
  labs(subtitle = "Loan Application Outcome Rates by Race and Year in Brooklyn", caption = "Home Mortgage Disclosure Act Data, CFPB, 2013-2017", color = "Outcome", x = "Year", y = "Rate")
```