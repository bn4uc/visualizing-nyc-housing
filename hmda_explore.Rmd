...
denial_reasons_race %>% 
  ...
  labs(title = "Credit History and Debt-to-Income Ratio are the two most frequent loan denial reasons", 
       ...
       caption = "Home Mortgage Disclosure Act Data, CFPB, 2013-2017", 
       x = "Applicant Race", y = "Denial Rate") + scale_fill_discrete(name = "Denial Reason")  + scale_fill_manual(values = c('#E8291A', '#004358', '#1f8a70', '#BEDB39', '#FFE11A', '#FD7400', '#E55EE8', '#8c4de8', '#6CC3F2'))
```
