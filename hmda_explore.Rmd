...
ggplot() + 
  ...
  labs(title = "Most census tracts have approval rates between \n60% and 80%", 
       subtitle = "The highest approval rates are mostly found \nin Queens, while rates dip below 40% in historically \nlower-income areas, such as East Brooklyn",
