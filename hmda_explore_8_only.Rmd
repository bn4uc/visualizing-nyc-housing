...
hmda_ny_5yrs %>% 
  ...
  labs(title = "Trends in Loan Amounts and Applicant Income suggest that for Applicants with the Same Income, Whites Apply for Smaller Loans than other Races", subtitle = "Approved Loans for Applicants with Incomes below $200,000 and Loan Amounts below $1,000,000, by Race \nYellow lines show an applicant with an income of $100,000 and a loan amount of $350,000. \nOn Average, a White applicant with an income of $100,000 is receiving a $350,000 loan, however, \na non-white applicant with same income is receiving a much larger loan", 
...
```{r, error = FALSE, message = FALSE, warning = FALSE, fig.align="left"}
...
#graph on loan approval rates over time (maybe move this up)
