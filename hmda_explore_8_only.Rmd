...
approval_rate_5yr %>% 
  ...
  theme(axis.text=element_blank(),                      
        ...
        plot.subtitle = element_text(face = "italic"),
        text = element_text(family = "Meiryo"), 
        axis.ticks = element_blank()) + labs(title ="Approval Rates for Low-to-Middle Income Applicants Decline \ndecline in most Boroughs, while Rates on Queens and Staten Island remain High", subtitle = "Approval Rates for Applicants with Incomes below $76,000/year", caption = "Home Mortgage Disclosure Act Data, CFPB, 2013-2017")
```
...
denial_reasons_race %>% 
  ...
  labs(title = "Black Applicants and Other (Native American and Pacific Islanders) Applicants Denials are more frequently due to Credit History, while this is an Infrequent Denial Reason for Whites and Asians", 
