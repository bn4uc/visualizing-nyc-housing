...
```{r, error = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.width = 15, fig.height=15}
...
ggplot(data = census_tract_merged) + 
  geom_sf(data = census_tract_merged, aes(fill = breaks), color = "white", lwd = 0) + facet_wrap(~applicant_race_name_1, ncol = 2) + 
