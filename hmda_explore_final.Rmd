...
hmda_ny_5yrs %>% 
  ...
  labs(title = "Trends in Loan Amounts and Applicant Income \nsuggest that for Applicants with the Same Income, \nWhites Receive Smaller Loans than other Races", subtitle = "Approved Loans for Applicants with Incomes below $200,000 and \nLoan Amounts below $1,000,000, by Race \n\nFor comparison, the orange lines show an income of $100,000 and \na loan amount of $350,000. On Average, a White applicant \nwith an income of $100,000 is receiving a $350,000 loan, \nhowever, a non-white applicant with same income \nis receiving a much larger loan", 
       ...
       y = "Applicant Income", x = "Loan Amount") + theme_bn + 
...
ggplot(data = nta_tract_merged) + 
  ...
  theme(axis.text=element_blank(),                      
        ...
        panel.background = element_rect(fill = "#ffffff", color = NA),
        axis.line = element_blank(),
        legend.position = "bottom") + guides(fill=guide_legend(title="Percent of Applications Approved (%)")) + scale_fill_manual(values = c("#fef0d9", "#fdcc8a", "#fc8d59", "#e34a33", "#b30000"))
